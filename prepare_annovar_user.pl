...
our $REVISION = '$Revision: 73b838cd45137220e2a62d61553a32a9d5f83b09 $';
...
sub prepareCosmic {
	...
	my ($mutid_index, $id_tumor_index, $primary_site_index);
	...
	if ($field[16] eq 'Mutation ID' or $field[16] eq 'GENOMIC_MUTATION_ID') {	#'Mutation ID' is for v89 and before, 'GENOMIC_MUTATION_ID' is for v90
		...
		die "Error: COSMIC MutantExport format error: column 17 or 18 or 12 should be 'Mutation ID' or 'GENOMIC_MUTATAION_ID' or 'ID_NCV'\n";
	}
